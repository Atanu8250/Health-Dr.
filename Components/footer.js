export default () => {
    return `
    <div id="thLogo">
      <div><img src="./Images/logo.png" alt="error"></div>
      <div>
        <p>Health-Dr</p>
        <p>EAT TO FIT</p>
      </div>
    ...
    <div>
      <div>
        ...
        <a href="howitworks.html#thpremium">Premium</a>
    ...
    <!-- <div></div> -->
    <div>
      <div><svg xmlns="http://www.w3.org/2000/svg" width="0.88em" height="1em" preserveAspectRatio="xMidYMid meet"
          viewBox="0 0 448 512">
      ...
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet"
          ...
          <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
            d="M17 44.23s5.36-22.32 5.89-23.72c-5.12.49-3.48 12.49 2.32 13.8c4.91 1.15 10.35-4.54 10.27-10.85S31.69 14 27 12.69s-12.15.31-14.13 6.87a10.53 10.53 0 0 0 3 11.47" />
          <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
            d="M24 2.5A21.5 21.5 0 1 0 45.5 24A21.51 21.51 0 0 0 24 2.5Z" />
        </svg>
      </div>
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet"
    ...
    <div>
      <p>Copyright 2008-2022 FitNow, Inc, All Rights Reserved</p>
      <p>Privacy | Terms of Service</p>
      <p>Do Not Sell My Personal Information</p>
    </div>
    <p>Health-Dr is among the federally registered trademarks of FitNow, Inc., and may not be used by third parties
